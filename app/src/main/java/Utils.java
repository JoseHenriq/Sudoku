...
public class Utils<EnumStorage> {
    ...
    static String TAG_Main   = "MAIN_LOG";
    private String TAG_Utils = "Utils";
    static String strLog     = new String();

    //--------------------------------------------------------------------------
    //
    //--------------------------------------------------------------------------
    public static enum EnumStorage {
    ...
    //--------------------------------------------------------------------------
    public static boolean VerificaPermissoes(Activity activity) {
    ...
    //-------------------------------------------------------------------------
    static boolean validate(Activity activity, int requestCode, String... permissions) {
    ...
    //-------------------------------------------------------------------------
/*
    static boolean VerificaExistArqsNecRaw(String [] strArNomeArqNeces) {
        ...
        try {
            ...
            Log.d(TAG_Main, "Erro: " + exc.getMessage());

        }
        Log.d(TAG_Main, strMsgUI);
...
*/
    ...
    //-------------------------------------------------------------------------
    public static int VerificaInfra(Context context) {

        //--- Instancializações e inicializações
        String TAG_Main   = "MAIN_LOG";
        int intInfraOk    = 0;
        ...
        Log.d(TAG_Main, "- path: " + envPath.getName());
        //----------------------------------------------------------------------
        // A1- Diretório "Relatorios"
        //----------------------------------------------------------------------
        folder = new File(envPath + File.separator + "Relatorios");
        if (!folder.exists()) {
            Log.d(TAG_Main, "- O diretório 'Relatorios' NÃO existe. Cria-o");
            //---------------------------------
            ...
            if (flagDirExiste) {
                ...
                Log.d(TAG_Main, "Não OK!");
                intInfraOk = -1;
            }

        } else {
            Log.d(TAG_Main, "- O diretório 'Relatorios' existe.");
        }
        ...
        if (intInfraOk != -1) {
            ...
            if (!folder.exists()) {
                ...
                Log.d(TAG_Main, "- O diretório 'Apache' NÃO existe. Cria-o");
                //---------------------------------
                flagDirExiste = folder.mkdirs();
                //---------------------------------
                if (flagDirExiste) {
                    flagCriado = true;
                    Log.d(TAG_Main, "- OK! Pendências.");
            ...
            //--- O diretório Apache já existe, verifica se o arquivo de dados já existe também.
                ...
                Log.d(TAG_Main, "- O diretório 'Apache' existe.");
            }
        }
        ...
        if (intInfraOk != -1 && !flagCriado) {
            ...
            if (!file.exists()) {
                ...
                Log.d(TAG_Main, "- O arquivo existe.");
            }
        }
        ...
        if (intInfraOk != -1) {
            ...
            if (!folder.exists()) {
                ...
                Log.d(TAG_Main, "- O diretório 'Teste_OffLine' NÃO existe. Cria-o");
                //---------------------------------
                flagDirExiste = folder.mkdirs();
                //---------------------------------
                if (flagDirExiste) {
                ...
                Log.d(TAG_Main, "- O diretório 'Teste_OffLine' existe.");
            }
            ...
            if (intInfraOk != -1 && !flagCriado) {
                ...
                if (!file.exists()) {
                    ...
                    Log.d(TAG_Main, "- O arquivo Init 1 existe.");
                }
                ...
                if (file.exists()) {
                    ...
                    if (!file.exists()) {
                        ...
                        Log.d(TAG_Main, "- O arquivo Init 2 existe.");
                    }
                }
                ...
                if (file.exists()) {
                    ...
                    if (!file.exists()) {
                        ...
                        Log.d(TAG_Main, "- O arquivo Href pag0001 existe.");
                    }
                }
                ...
                if (file.exists()) {
                    ...
                    if (intIdx > 20) {
                        Log.d(TAG_Main, "- Os arquivos Href existem.");
                    }
                }
            }
        }
        ...
        Log.d(TAG_Main, "- Ret = " + String.valueOf(intInfraOk) + "   " + strResp);
    ...
    public static String LeDataHora (String strFormatDataHora) {
    ...
    //-------------------------------------------------------------------------
    public static boolean EscritaTextFile(String strFileName, String strConteudo) {
    ...
    public static ArrayList <String> LeituraTextFile (String strFileName) {
        ...
        try {
            ...
            strArLstLeit = new ArrayList<>();
            Log.d(TAG_Main, "Erro na leitura de: " + strFileName);
            Log.d(TAG_Main, "Exc: " + exc.getMessage());
    ...
    //------------------------------------------------------------------------------------
    public static boolean myDeleteDir(String strDirName) {

        Log.d(TAG_Main, "--> Deleta Diretório " + strDirName);
    ...
    //--------------------------------------------------------------------------------------
    public static boolean myDeleteAllFiles (String strDirName, String [] strArRegEx) {

        Log.d(TAG_Main, "--> Deleta Arquivos no Diretório " + strDirName);
        boolean flagDelOk = true;
        String rootDirName = Environment.getExternalStorageDirectory().toString() + strDirName;
        File Dir = new File(rootDirName);
        try {
    ...
    //--------------------------------------------------------------------------------------
    public static boolean myDeleteFile (String strDirName, String strFileName) {

        Log.d(TAG_Main, "--> Deleta Arquivo do Diretório " + strDirName);
    ...
    //--------------------------------------------------------------------------
    public static String[] ListaArqDir (String strDirName) {

        Log.d(TAG_Main, "--> Lista arquivos do diretorio");
        String[] children   = new String[] {""};

        String rootFileName = Environment.getExternalStorageDirectory().toString() + strDirName;
        ...
        try {
            ...
            if (file.isDirectory()) {
                ...
                if (files.length > 1) {
                    for (File file_ : files) {
                        ...
                        Log.d(TAG_Main, String.valueOf(intIdx++) + " " + file_.toString());
                ...
                for (String child : children) {
                    ...
                    Log.d(TAG_Main, String.valueOf(intIdx++) + " " + child.toString());
            ...
            Log.d(TAG_Main, "Erro: " + exc.toString());
    ...
    public static ArrayList <String> LeituraTextFileRaw (Context context, String strFileName) {
        ...
        try {
            ...
            Log.d("TAG_MAIN", "Leitura do arq raw:");
            for (String strArqLine : strArLstArq) {
                Log.d("TAG_MAIN", (strArqLine + "\n\r"));
            }
    ...
    */
    ...
    //--------------------------------------------------------------------------
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    public static ArrayList<Uri> ObtemURIgranteds(Context contxt, String [] strArNomeArqs) {
        ...
        Log.d(TAG_Main, "--> Obtém URIs granteds");
        ...
        try {
            ...
            if (strArNomeArqs != null) {
                ...
                for (String strNomeArq : strArNomeArqs) {
                    ...
                    Log.d(TAG_Main, "- filelocation: " + filelocation.toString());
                    try {
                        ...
                        Log.d(TAG_Main, "granted!");

                    } catch (IllegalArgumentException e) {

                        Log.e(TAG_Main, "Error: " + e.getMessage());
                        flagGranstOk = false;
                    }
                }
            }
            ...
            Log.d(TAG_Main, "Erro email: " + exc.getMessage());
            flagGranstOk = false;
        }
    ...
    //---------------------------------------------------------------------
    public static int indexOf (String strNomeArq, String [] strArTodosArqRaw) {
    ...
    //-------------------------------------------------------------------------
    public static void UI_Dialog (Context context, String strTitle, String strDialogo,
...
/*
    ...
    */
    ...
    // https://stackoverflow.com/questions/45373007/progressdialog-is-deprecated-what-is-the-alternate-one-to-use
    static AlertDialog alertProgDialog = null;
    static String strMsgPD             = new String();
    //-------------------------------------------------------------------------
    public static void setAlertProgressDialog(Context context, String strMsg) {
    ...
    // https://stackoverflow.com/questions/45373007/progressdialog-is-deprecated-what-is-the-alternate-one-to-use
    //-------------------------------------------------------------------------
    public static boolean alertProgDialogDismiss() {
        ...
        try {
            ...
            if (alertProgDialog.isShowing()) {
                ...
                Log.i(TAG_Main, "aPD is showing; cancel it");
                alertProgDialog.cancel();
                strMsgPD = "";

            } else {
                Log.i(TAG_Main, "aPD is not showing");
            }
    ...
    public static void customToast(Context context, String msg) {
        ...
        toastMessage.setTextSize(convertSpToPixels(textSizeInSp , context.getApplicationContext()));
        toastL.show();
...
*/
    ...
    //--------------------------------------------------------------------------
    public static String TirarAcentos (String strPalavraComAcento) {
